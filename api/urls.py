...
from .views import (
    # PlayerListView, PlayerView, CreatePlayerView, UpdatePlayerDetailsView,
    TaskListView, TaskView, CreateTaskView, UpdateTaskView, #AssignTaskToPlayerView,
    CardListView, CardView, CreatePurchaseRecordView#, PlayerCardListView
)
...
urlpatterns = [
    ...
    #path('task/<int:player_id>/task/', AssignTaskToPlayerView.as_view(), name='assign-task'), --fix player first
